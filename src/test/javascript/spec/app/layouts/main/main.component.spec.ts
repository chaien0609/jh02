...
import { Jh02TestModule } from '../../../test.module';
  ...
  describe('MainComponent', () => {
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [Jh02TestModule, TranslateModule.forRoot()],
    ...
    describe('page title', () => {
      ...
      const langChangeEvent: LangChangeEvent = { lang: 'ja', translations: null };
      ...
      beforeEach(() => {
        ...
        translateService.currentLang = 'ja';
